      ...
      <AnimatePresence mode="wait" custom={direction}>
        ...
        >
          <Link
            ...
            className="relative block cursor-pointer px-6 py-8 text-ink"
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="font-display mt-4 max-w-[58%] text-2xl font-semibold leading-tight">
                {t("promo_title")}
              </h2>
      ...
      <div className="mt-5 flex justify-center gap-2">
        {featured.map((item, i) => (
          <button
            ...
            type="button"
            onClick={() => goTo(i)}
            className={`h-1.5 rounded-full transition-all ${i === index ? "w-5 bg-primary" : "w-1.5 bg-hairline"}`}
